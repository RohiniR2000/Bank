...
public class decryption {
    ...
    {
        try{
            f2=new FileWriter("C:\\Users\\ROHINI\\Documents\\NetBeansProjects\\internetbanking\\internetbanking\\second_decryption.txt");
            f3=new FileWriter("C:\\Users\\ROHINI\\Documents\\NetBeansProjects\\internetbanking\\internetbanking\\decrypted.txt");
            f1=new FileWriter("C:\\Users\\ROHINI\\Documents\\NetBeansProjects\\internetbanking\\internetbanking\\first_decryption.txt");
        String substring="";
        int j=0,sk=secretkey.intValue();
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\ROHINI\\Documents\\NetBeansProjects\\internetbanking\\internetbanking\\Encryption.txt"));
    String line;
